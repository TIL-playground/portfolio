        ...
        <PortfolioBody>
          ...
          <BodyContent>
            ...
            <BodyContentDiv>
              <p>
                스프링 웹 플럭스를 활용한 
                <PointColor> 비동기 논블로킹 웹 애플리케이션</PointColor> 개발에 전문성을 갖추고 있으며, 성능 최적화와 유지보수성 향상을 최우선으로 삼고 있습니다. 전교생이 사용하는 이력서 작성 플랫폼 프로젝트를 주도하여 
                <PointColor> 대규모 트래픽을 안정적으로 처리</PointColor>할 수 있는 시스템 설계와 구현에 기여했습니다.
              </p>
              <p>
                항상 최신 기술 트렌드를 학습하며, 
                <PointColor> 클린 코드 작성과 시스템 성능 최적화 사이의 균형</PointColor>을 중요하게 여깁니다. 앞으로도 지속적인 학습과 도전을 통해 가치 있는 개발자로 성장하는 것이 목표입니다.
              </p>
            </BodyContentDiv>
            <HyperlinkContainer>
        ...
        <div>
          ...
          <DaemawikiProjects>
            ...
            <div>
              ...
              <ProjectLink href="https://github.com/daemawiki/claude" target="_blank">
          ...
          <RepoProjects>
            <div>
              <ProjectTitleLogoContainerLeft>
                <a href="https://www.dsm-repo.com" target="_blank" rel="noreferrer">
              ...
              <ProjectContentLeft>
                ...
                <ProjectLink href="https://github.com/dsm-repo/Whopper" target="_blank">
